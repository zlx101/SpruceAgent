export function createGatewayClient(options = {}) {
  ...
  return {
    ...
    releaseArtifactManifests: (input = {}) => request("GET", `/v1/release-artifacts${limitParams(input)}`),
    releaseArtifactManifest: (manifestId) => request("GET", `/v1/release-artifacts/${encodePathPart(manifestId)}`),
    createReleaseArtifactManifest: (input = {}) => request("POST", "/v1/release-artifacts/manifest", input),
    releaseArtifactManifestContract: () => request("GET", "/v1/release-artifacts/contract"),
    ...
    executionTaskEventContract: () => request("GET", "/v1/execution-tasks/events/contract"),
    ...
    executionTaskEvents: (taskId, input = {}) => request("GET", `/v1/execution-tasks/${encodePathPart(taskId)}/events${limitParams(input)}`),
